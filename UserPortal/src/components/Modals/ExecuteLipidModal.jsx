...
const LipidModal = ({ crid, show, handelCloseEditModal, campReportList }) => {
    ...
    for (const b of selectedBrands) {
      ...
      files.forEach((file) => {
        formData.append(`files_${brandId}[]`, file);
            ...
            console.error(error);
            setPopup({ type: "error", message: "Something went wrong while executing camp" });
              ...
              <form className="row g-3">
                ...
                <div className="form-group col-md-4 did-floating-label-content">
                  <input
                    ...
                    placeholder="JUPIROS DIET CARE KIT Utilised*"
