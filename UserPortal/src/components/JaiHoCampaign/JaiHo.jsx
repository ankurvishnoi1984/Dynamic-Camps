...
const JaiHo = () => {
  ...
  const [isCouponsGiven, setCouponsGiven] = useState("N");
  const [isCouponsUtilized,setCouponseUtilized] = useState("N");
  ...
  const getCampReportList = async () => {
    ...
    try {
      const res = await axios.post(
        `${BASEURL2}/dashboard/getCampReportListWithActivity?searchName=${searchQuery}`,
        { ...filters, userId,activityId:'3' }
      );
      if (res?.data?.errorCode == "1") {
  ...
  const getBrandList = async()=>{
    ...
    const getDoctorList = async () => {
      try {
        const res = await axios.post(`${BASEURL2}/doc/getDoctorList`,{userId:userId});
  ...
  const handleAddSubmit = async () => {
    ...
    // Jai ho activity id 3
    formData.append("activityId",3)
    formData.append("isCouponsGiven",isCouponsGiven)
    formData.append("isCouponUtilized",isCouponsUtilized)
                  ...
                  <form className="row g-3">
                    ...
                    {/* <div className="col-md-4 did-floating-label-content">
                      <input
                        ...
                        className="form-control did-floating-input"
                        placeholder="Camp Date"
                        value={infoData && infoData.camp_time1}
                        readOnly
                      />
                      <label className="form-label did-floating-label">
                        Time
                    ...
                    <div className="form-group col-md-4 did-floating-label-content">
                      <input
                        ...
                        value={infoData && infoData.screen_count}
                        readOnly
                      />
                      <label className="form-label did-floating-label">
                        Patients Screened
                    ...
                    <div className="form-group col-md-4 did-floating-label-content">
                      <input
                        ...
                        className="form-control did-floating-input"
                        placeholder="Rx No."
                        value={infoData && infoData.rx_count}
                        readOnly
                      />
                      <label className="form-label did-floating-label">
                        Rx Generated
                    ...
                    {brandMapping.length>0 && 
                    brandMapping.map((data)=>(
                      <div key={data.bmid} className="row">
                            <div className="form-group col-md-4 did-floating-label-content">
                        <input
                          type="text"
                          className="form-control did-floating-input"
                    ...
                    {/* <div>{campImages &&
                    campImages.length > 0 ?"Camp Images":""}</div>
                ...
                <div className="modal fade show" style={{ display: "block" }}>
                  <div className="modal-dialog modal-xl">
                    <div className="modal-content">
                      ...
                      <div className="form-group col-md-4 did-floating-label-content">
                        <input
                          ...
                          readOnly
                        />
                        <label className="form-label did-floating-label">Is Doctor Rps</label>
                      </div>
                    {/* <div className="form-group col-md-4 did-floating-label-content">
                        <input
                          type="number"
                    ...
                    <div className="form-group col-md-4 did-floating-label-content">
                      <select
                        className="form-control did-floating-select"
                        value={isCouponsGiven}
                        onChange={(e) => setCouponsGiven(e.target.value)}
                      >
                        <option value="Y">Yes</option>
                        <option value="N">No</option>
                      </select>
                    ...
                    <div className="form-group col-md-4 did-floating-label-content">
                      <select
                        className="form-control did-floating-select"
                        value={isCouponsUtilized}
                        onChange={(e) => setCouponseUtilized(e.target.value)}
                      >
                        <option value="Y">Yes</option>
                        <option value="N">No</option>
                      </select>
                      ...
                      {isPrescriptionGen==="Y"&&brandInputs.map((input, index) => (
                        <React.Fragment key={index}>
                          <div className="form-group col-md-4 did-floating-label-content">
                            <select
                              className="form-control did-floating-select"
                              value={input.brand} // controlled value
                              onChange={(e) => handleChange(index, "brand", e.target.value)} // update brandInputs
                            >
                            ...
                            <label className="form-label did-floating-label">Brand</label>
                          </div>
                        </React.Fragment>
                      ))}


                    {isPrescriptionGen === "Y" && <div className="col-12 mt-3">
                      <button
                        type="button"
...
{  isPrescriptionGen==="Y"&& <div className="form-group col-md-4 did-floating-label-content">
                              <label
                                htmlFor="fileInput"
                                className={`form-label  ${selectedFiles.length >= ImageLimit ?"custom-file-label1":"custom-file-label"}`}
                                // style={{
                                //   pointerEvents:
                              ...
                              >
                                {" "}
                                {selectedFiles.length >0 && selectedFiles.length <ImageLimit ? "Add More Prescription":"Upload Prescription"}
                              </label>
                              ...
                              <input
                                ...
                                disabled={selectedFiles.length >= ImageLimit}
                              />
                            </div>}
                            <div
                              style={{
