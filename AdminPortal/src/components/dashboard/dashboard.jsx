...
function Dashboard() {
 ...
 const [show,setShow]= useState(false);
  ...
  const handelReportDownload = () => {
    ...
    XLSX.writeFile(wb, 'alkem_admin_dashboard_report.xlsx');
          ...
          <div className="card border-left-primary shadow h-100 py-2">
            <div className="card-body">
              <div className="row no-gutters align-items-center">
                ...
                <div className="col-auto">
                  <i className="fas fa-file-image fa-2x text-gray-300"></i>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="card-body">
              <div className="row no-gutters align-items-center">
                <div className="col mr-2">
                  ...
                  <div className="h5 mb-0 font-weight-bold text-gray-800">{totals.totalApprovalPendingCount}</div>
                </div>
                <div className="col-auto">
        ...
        <div className="card-body">
          <div className="table-responsive">
            <table className="table table-bordered" id="dataTable" width="100%" cellSpacing="0">
              ...
              <tbody>
                {dashboardSummary && dashboardSummary.map((e) => {
                  return (

                    <tr key={`${e.activity_name}-${e.total_camps}`}>
                      <td>{e.activity_name}</td>
                      <td>{e.total_camps}</td>
                      <td>{e.total_patient_screened}</td>
                      <td>{e.total_prescriptions}</td>
