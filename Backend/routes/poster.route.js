...
const { getAllPosterDoctorsByEmp, getCategory, updatePosterDoctor, addPosterDoctor, AddPoster, getPosterByDoctorId, downloadPoster } = require("../controller/poster.controller");
